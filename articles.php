...
<body class="bg-slate-950 text-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="flex justify-between items-center h-16">
        ...
        <div class="hidden md:block">
          <a href="./index.php" class="px-6 py-2 bg-emerald-500 hover:bg-emerald-600 rounded-lg font-semibold transition duration-300">Back Home</a>
        </div>
  ...
  <div id="mobileMenu" class="hidden fixed top-16 left-0 right-0 bg-slate-800 md:hidden z-40 border-b border-slate-700">
    <div class="px-4 py-4 space-y-2">
      ...
      <a href="./index.php" class="block w-full mt-4 px-4 py-2 bg-emerald-500 hover:bg-emerald-600 rounded text-center font-semibold">Back Home</a>
    </div>
  </div>
    ...
    <div class="max-w-7xl mx-auto">
      <section class="pb-14">
        <div class="text-center max-w-3xl mx-auto">
          ...
          <h1 class="text-4xl sm:text-5xl font-semibold text-white mb-5">Professional content for operational excellence</h1>
        ...
        <div class="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <div class="rounded-[28px] border border-slate-800/80 bg-slate-900/90 p-6 shadow-[0_20px_40px_rgba(15,23,42,0.2)]">
            ...
            <p class="text-4xl font-semibold text-white"><?= count($articles) ?></p>
          </div>
          <div class="rounded-[28px] border border-slate-800/80 bg-slate-900/90 p-6 shadow-[0_20px_40px_rgba(15,23,42,0.16)]">
            ...
            <p class="text-4xl font-semibold text-white">Modern, clean layout</p>
          </div>
          <div class="rounded-[28px] border border-slate-800/80 bg-slate-900/90 p-6 shadow-[0_20px_40px_rgba(15,23,42,0.16)]">
            <p class="text-sm uppercase tracking-[0.32em] text-slate-400 mb-3">Brand tone</p>
            <p class="text-4xl font-semibold text-white">Minimal and professional</p>
          </div>
        </div>
      </section>
